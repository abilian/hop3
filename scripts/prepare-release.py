# Forked from https://github.com/litestar-org/litestar/blob/main/tools/prepare_release.py
# The MIT License (MIT)
...
# SPONSORS = f"- A huge 'Thank you!' to all sponsors across {_polar}, {_open_collective} and {_github_sponsors}!"
SPONSORS = ""
ORG_NAME = "abilian"
REPO_NAME = "hop3"
BASE_URL = f"https://github.com/{ORG_NAME}/{REPO_NAME}"
...
class ReleaseInfo:
    ...
    def compare_url(self) -> str:
        return f"{BASE_URL}/{self.base}...{self.release_tag}"
