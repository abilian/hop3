...
body (adjudicated by forall against the source; the production module keeps
zero forall dependency). All three are IDENTITY contracts: a validator
...
Adjudicated by ``proofs/test_identifiers_contracts.py``, or by hand:
    ...
    forall check packages/hop3-server/src/hop3/core/identifiers.py \\
