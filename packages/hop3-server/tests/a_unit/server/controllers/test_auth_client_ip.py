...
"""X-Forwarded-For trust in _client_ip (audit H1 — rate-limit bypass)."""

from __future__ import annotations

from dataclasses import dataclass

from hop3.server.controllers.auth import _client_ip
...
class _FakeRequest:
    """Minimal stand-in exposing the .client / .headers _client_ip reads."""
...
def test_configured_trusted_proxy_is_honored(monkeypatch):
    ...
    assert _client_ip(other) == "10.0.0.6"
