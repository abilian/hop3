...
from .annotations import DEFAULT_TYPE_MAPPING, TypeMapping, annotations2schema
...
class WebargsHTTPException(HTTPException):
    ...
    messages, the underlying exception, the `marshmallow.Schema` used to parse
    the request, headers."""
...
class StarletteParser(AsyncParser):
    ...
    def get_request_from_view_args(
        ...
        """Get request object from a handler function or method.
    ...
    def use_annotations(
        self,
        fn: typing.Callable | type[HTTPEndpoint] | None = None,
        *,
        type_mapping: TypeMapping = None,
        **kwargs,
    ) -> typing.Callable[..., typing.Callable] | type[HTTPEndpoint]:
