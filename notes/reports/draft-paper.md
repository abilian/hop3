...
Work on Hop3 repeatedly ran into gaps in the surrounding tooling, and several of the resulting tools became artefacts in their own right. Some of the claims in this report are checkable because a tool was written to check them.
...
Hop3 began from Piku, by Rui Carmo and its contributors, and retains code from it; it also carries code from Nua, by the Abilian development team. Both are gratefully acknowledged.
