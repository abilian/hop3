...
Beyond the named milestones, 0.6 also delivered two cross-cutting platform features — **resource limits and volumes** (ADR 046 Phase 2) and the **signed app-catalog distribution** (ADR 049, ADR 031) — plus a secret/config single-sourcing fix (ADR 048). These are detailed below.
