...
- [Code Cleanup Tasks](#code-cleanup-tasks)
  ...
  * [17. Consolidate Bundled Installer Locations](#17-consolidate-bundled-installer-locations)
  * [18. Migrate MySQL Addon to Database-Stored Credentials](#18-migrate-mysql-addon-to-database-stored-credentials)
