...
- **Type**: Feature
- **Created**: 2026-06-16
- **Related-ADRs**: [013](./013-supply-chain.md) (supply chain), [031](./031-project-terminology.md) (terminology), [019](./019-cli-commands.md) (CLI commands), [002](./002-config-format.md) (config format)
...
5. **Transparency + attestation**: Sigstore/Rekor + in-toto provenance and per-release SBOM ([ADR 013](./013-supply-chain.md)); two-tier trust if third-party maintainers submit specs.
...
| F3 | The verifying public key is a compiled-in constant. |
...
- [ADR 002](./002-config-format.md): Detailed hop3.toml Format (the schema the coexistence gate relies on)
- [ADR 013](./013-supply-chain.md): Software Supply Chain Security and SBOMs (sha256 pinning; Sigstore deferred)
- [ADR 031](./031-project-terminology.md): Project Terminology (Catalog vs Marketplace)
- [ADR 019](./019-cli-commands.md): CLI Commands
