...
"""Demo 28: Docker app with MySQL addon - Page Counter.

A simple Flask application running in Docker that connects to a MySQL database
provisioned via Hop3 addons. Implements a basic page view counter.
"""
...
def get_db_connection():
    ...
    # Or use individual env vars for more reliability
    ...
    if db_configured:
        ...
        if count == -1:
            return jsonify({
                "app": "demo28",
                "type": "docker + mysql",
                "message": "Welcome to demo28 - MySQL Page Counter!",
