...
"""Demo 47: Minimal Ruby/Sinatra with MySQL.

Tests Ruby + mysql2 gem connectivity to isolate SSL issues.
"""
...
# Demo metadata
TITLE = "Demo 47: Ruby/Sinatra + MySQL"
DESCRIPTION = """
Demonstrates minimal Ruby app with MySQL:
  - Docker-based deployment
  - MySQL addon for data storage
  - Tests Ruby + mysql2 gem connectivity
"""
...
def run(ctx: DemoContext) -> None:
    ...
    # Show app structure
    print_header("Deploying Ruby/Sinatra + MySQL")

    show_app_structure(
        APP_NAME,
        [
            ("Dockerfile", "Docker image based on ruby:3.2-alpine"),
            ("app.rb", "Sinatra app with MySQL connection (ssl_mode: disabled)"),
            ("hop3.toml", "Hop3 configuration with [[provider]] section"),
        ],
    )
    print_info("This is a minimal test to verify Ruby + mysql2 works.")
    print_blank()
    pause(ctx.pause_between_steps)
    ...
    cleanup_app(ctx, APP_NAME, app_url)
    print_success("Demo 47 completed: Ruby/Sinatra + MySQL works!")
