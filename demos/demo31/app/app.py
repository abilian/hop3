...
"""Demo 31: Native Python app with PostgreSQL addon.

A Flask application deployed natively that connects to a PostgreSQL database
...
def home():
    ...
    return jsonify({
        "app": "demo31",
        "type": "native",
        "message": "Welcome to demo31 - Native Python + PostgreSQL!",
