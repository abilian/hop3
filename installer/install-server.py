...
server {{
    ...
    # The server handles: /, /login, /logout, /profile, /dashboard/*, /rpc, /health, /static/*
    location / {{
    ...
    # ACME challenge for Let's Encrypt (must be served from filesystem)
    location /.well-known/acme-challenge/ {{
        root /var/www/html;
    }}
}}
...
def print_final_message(
    ...
    if domain:
        print(f"    Admin UI:  https://{domain}/")
        print(f"    API (RPC): https://{domain}/rpc")
    else:
