---
tutorial:
  name: spring-boot-hop3-tutorial
  teardown:
  - rm -rf hop3-tuto-spring-boot 2>/dev/null || true
  - hop3 app destroy --app hop3-tuto-spring-boot -y 2>/dev/null || true
---
...
```assert file-exists path=hop3-tuto-spring-boot
```

Create the Maven build file:

```file path=hop3-tuto-spring-boot/pom.xml
...
```bash exec id=create-dirs dir=hop3-tuto-spring-boot
mkdir -p src/main/java/com/example/demo src/main/resources
```

```assert file-exists path=hop3-tuto-spring-boot/src/main/java/com/example/demo
```
...
```file path=hop3-tuto-spring-boot/src/main/java/com/example/demo/MyappApplication.java
...
```file path=hop3-tuto-spring-boot/src/main/java/com/example/demo/WelcomeController.java
package com.example.demo;
...
```file path=hop3-tuto-spring-boot/src/main/java/com/example/demo/HealthController.java
package com.example.demo;
...
```file path=hop3-tuto-spring-boot/src/main/resources/application.properties
...
```file path=hop3-tuto-spring-boot/src/main/resources/application-production.properties
...
```bash exec id=build-app dir=hop3-tuto-spring-boot timeout=300
...
```bash exec id=verify-jar dir=hop3-tuto-spring-boot
ls -la target/*.jar
```
...
```bash exec id=test-app dir=hop3-tuto-spring-boot timeout=30
...
```file path=hop3-tuto-spring-boot/Procfile
...
```file path=hop3-tuto-spring-boot/hop3.toml
[metadata]
...
```bash exec id=verify-deploy-files dir=hop3-tuto-spring-boot
...
```file path=hop3-tuto-spring-boot/.gitignore
...
```bash exec id=git-init dir=hop3-tuto-spring-boot
git init
```
...
```bash exec id=git-add dir=hop3-tuto-spring-boot
git add .
```

```bash exec id=git-commit dir=hop3-tuto-spring-boot
...
```bash exec id=deploy dir=hop3-tuto-spring-boot timeout=120
...
```bash exec id=redeploy dir=hop3-tuto-spring-boot timeout=120
hop3 deploy --app hop3-tuto-spring-boot
```
