...
hop3 env set --app hop3-tuto-fiber HOST_NAME=hop3-tuto-fiber.$HOP3_TEST_DOMAIN
```
...
hop3 env show --app hop3-tuto-fiber
hop3 env set --app hop3-tuto-fiber NEW_VAR=value
