...
```bash exec id=check-dotnet-sdks
...
```bash exec id=create-project timeout=60
...
```assert file-exists path=hop3-tuto-aspnet-core/hop3-tuto-aspnet-core.csproj
```

Verify the project structure:

```bash exec id=verify-structure dir=hop3-tuto-aspnet-core
ls -la
```
...
```bash exec id=install-swagger dir=hop3-tuto-aspnet-core timeout=60
...
```file path=hop3-tuto-aspnet-core/Program.cs
...
```bash exec id=remove-default dir=hop3-tuto-aspnet-core
...
```bash exec id=build-app dir=hop3-tuto-aspnet-core timeout=120
dotnet build
```
...
```bash exec id=test-app dir=hop3-tuto-aspnet-core timeout=20
...
```bash exec id=publish-app dir=hop3-tuto-aspnet-core timeout=180
...
```bash exec id=verify-publish dir=hop3-tuto-aspnet-core
ls -la publish/
```
...
```file path=hop3-tuto-aspnet-core/Procfile
...
```file path=hop3-tuto-aspnet-core/hop3.toml
[metadata]
...
```bash exec id=verify-deploy-files dir=hop3-tuto-aspnet-core
...
```file path=hop3-tuto-aspnet-core/.gitignore
# Build output
bin/
obj/
publish/
...
```bash exec id=git-init dir=hop3-tuto-aspnet-core
git init
```
...
```bash exec id=git-add dir=hop3-tuto-aspnet-core
git add .
```

```bash exec id=git-commit dir=hop3-tuto-aspnet-core
...
```bash exec id=deploy dir=hop3-tuto-aspnet-core timeout=120
...
```bash exec id=redeploy dir=hop3-tuto-aspnet-core timeout=120
hop3 deploy hop3-tuto-aspnet-core
```
