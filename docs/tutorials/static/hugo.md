...
hop3 env set --app hop3-tuto-hugo HOST_NAME=hop3-tuto-hugo.$HOP3_TEST_DOMAIN
```
...
hop3 env show --app hop3-tuto-hugo
hop3 env set --app hop3-tuto-hugo NEW_VAR=value
