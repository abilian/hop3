...
hop3 deploy --app hop3-tuto-falcon
```
...
hop3 env set --app hop3-tuto-falcon HOST_NAME=hop3-tuto-falcon.$HOP3_TEST_DOMAIN
```
...
hop3 env show --app hop3-tuto-falcon
hop3 env set --app hop3-tuto-falcon NEW_VAR=value
