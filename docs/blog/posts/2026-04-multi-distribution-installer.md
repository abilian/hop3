...
We use Hetzner Cloud to spin up VMs for each distribution. The `hop3-test matrix` command drives a single image, a list, or the whole matrix:
...
hop3-test matrix --image rocky-9

# Test several at once
hop3-test matrix --images debian-13,fedora-42,alma-9
