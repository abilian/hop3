...
*Ready to get started? Follow our [first deployment tutorial](2026-01-deploying-first-app.md) to deploy your first app. For configuration details, see the [hop3.toml reference](2026-02-hop3-toml-reference.md).*
