...
```bash
hop3 env set --app hop3-tuto-robyn HOST_NAME=hop3-tuto-robyn.$HOP3_TEST_DOMAIN
```
...
hop3 env show --app hop3-tuto-robyn
hop3 env set --app hop3-tuto-robyn NEW_VAR=value
