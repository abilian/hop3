...
5. **Package it**: Follow the [External Plugin Guide](../../external-plugins.md)
...
- [Plugin Development Guide](../../plugin-development.md) - Comprehensive plugin guide
...
- [External Plugin Guide](../../external-plugins.md) - Publishing plugins
