...
This document delineates the governance policy for the Project. By appending their name to the maintainers.md file, maintainers signify their consent to this policy and commit to observing all Project policies, including the [code of conduct](../reference/policies/code-of-conduct.md).
